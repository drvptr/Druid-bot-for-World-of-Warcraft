...
transform = transforms.Compose([
    ...
    transforms.ToTensor(),
    transforms.Normalize(mean=[0.485, 0.456, 0.406], std=[0.229, 0.224, 0.225]),  # Нормализация, как у ImageNet
])
...
while True:
    ...
    # Проверяем, что есть предсказания и рисуем
